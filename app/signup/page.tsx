            ...
            <div className="flex h-full w-full items-center bg-black p-8 md:w-1/2 md:p-[60px]">
                ...
                >
                    ...
                    <div className="mb-[30px]">
                        <h1 className="mb-4 text-[48px] font-bold uppercase leading-none tracking-tight text-white italic">
                            Join the Inner Circle
                        </h1>
                        <p className="text-base font-normal leading-relaxed text-[#888888]">
                            Unlock exclusive access to new drops, sales, and member-only events.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="mb-5 space-y-5">
                        <div className="space-y-2">
                            <label htmlFor="name" className="block text-[11px] font-semibold tracking-widest text-[#A0A0A0] uppercase">
                                FULL NAME
                            </label>
                            <input
                                type="text"
                        ...
                        >
                            <span className="relative z-10">{isSubmitting ? 'JOINING...' : 'BECOME A MEMBER'}</span>
                    ...
                    <div className="relative my-8 flex items-center">
                        ...
                        <span className="px-4 text-[11px] font-medium tracking-widest text-[#666666] uppercase">OR SIGN UP WITH</span>
                        <div className="h-[1px] flex-grow bg-[#333333]" />
                    </div>

                    {/* Social Auth */}
                    <div className="mb-8 flex space-x-[15px]">
                    ...
                    <div className="text-center">
                        <p className="text-sm text-[#888888]">
                            Already a member?{' '}
                            <Link href="/login" className="font-bold text-white transition-opacity hover:opacity-80 hover:underline">
                                Sign In
                            </Link>
                        </p>
                    </div>
            ...
            <AnimatePresence>
                {showSuccess && (
                    ...
                    >
                        ...
                        <div>
                            <div className="font-semibold">Welcome to the Club!</div>
                            <div className="text-[13px] opacity-90">Your account is ready, {name || 'Member'}.</div>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
